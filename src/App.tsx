...
></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                onClick={() => window.location.href = "https://horizon.netscout.com/?mapPosition=0.00~-0.30~1.00"}
                className="border border-red-500 text-red-400 px-8 py-4 rounded-lg text-lg font-medium hover:bg-red-900/20 transition-colors">
                VIEW THREAT MAP
                </button>
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            {/* URL Scan */}
            <div className="bg-black-900/70 rounded-2xl shadow-md p-6 text-center border border-yellow-500/30">
              ...
              <button
                ...
                className="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition"
              >
                Scan URL
              </button>
            </div>
            ...
            {/* PDF Scan */}
            <div className="bg-black-900/70 rounded-2xl shadow-md p-4 text-center border border-yellow-500/30">
              <h3 className="text-lg font-semibold mb-3">📄 PDF Scan</h3>
              <input
                type="file"
                accept="application/pdf"
                onChange={onFileInputChange}
                className="w-full p-2 rounded mb-3 text-blue"
              />
              <button
                onClick={handleFileScan}
                className="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition"
              >
                Scan PDF
              </button>
            </div>
            ...
            <div className="bg-black-900/70 rounded-2xl shadow-md p-6 text-center border border-yellow-500/30">
              ...
              <button
                ...
                className="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition"
              >
                Scan Image
              </button>
            </div>
      ...
      <footer className="bg-black py-12 border-t border-red-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-red-900/30 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 VIRUSSHIELD AI. Maximum Protection Guaranteed.
            </p>
          </div>
        </div>
      </footer>
